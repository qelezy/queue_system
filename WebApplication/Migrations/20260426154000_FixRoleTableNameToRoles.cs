...
namespace WebApplication.Migrations
{
    ...
    [Migration("20260426154000_FixRoleTableNameToRoles")]
    public partial class FixRoleTableNameToRoles : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                -- Normalize users table name.
                ...
                -- Last-resort roles table creation for environments with broken history.
                IF OBJECT_ID(N'[dbo].[roles]', N'U') IS NULL
                BEGIN
                ...
                -- Ensure user profile fields expected by model exist.
                IF OBJECT_ID(N'[dbo].[user]', N'U') IS NOT NULL
                BEGIN
                    IF COL_LENGTH(N'[dbo].[user]', N'first_name') IS NULL
                        ALTER TABLE [dbo].[user] ADD [first_name] nvarchar(100) NOT NULL CONSTRAINT [DF_user_first_name] DEFAULT N'';

                    IF COL_LENGTH(N'[dbo].[user]', N'last_name') IS NULL
                        ALTER TABLE [dbo].[user] ADD [last_name] nvarchar(100) NOT NULL CONSTRAINT [DF_user_last_name] DEFAULT N'';
